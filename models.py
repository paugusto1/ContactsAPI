...
#   filename:  model.json
#   timestamp: 2022-09-23T01:34:19+00:00
#
#   Pydantic classes defining Contact fields
...
class AddressSingle(BaseModel):
    ...
    postalCode: Optional[constr(regex=r'^[0-9]{5}-?[0-9]{3}$')] = Field(
...
class PhoneNumberSingle(BaseModel):
    ...
    value: constr(regex=r'^(\([0-9]{2}\))?[0-9]{4,5}-?[0-9]{4}$') = Field(
